...
1. **AI任职5+免认证**：
   - 最高有效AI任职为`5级`、`6级`、`7级`或`8级`时，免专业级证书/科目二校验，直接视为认证达标
   - 任职取自`t_qualifications`当前有效期内的最高级别
...
3. **非软件类干部通过专业级科目二考试**：
   ...
   - 专业级科目二考试代码：`EXCN022303075ZA20`、`EXCN022303075ZA2E`、`EXCN022303075ZA2A`（需在`t_exam_record`表中存在该`exam_code`且`is_pass`为1的记录）
   - 将`is_cert_standard`字段更新为1
